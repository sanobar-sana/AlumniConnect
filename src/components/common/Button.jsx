...
export const Button = ({
  ...
  const variants = {
    ...
    secondary: 'bg-zinc-150 hover:bg-zinc-200 text-zinc-900 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-100 focus:ring-zinc-500 dark:focus:ring-offset-zinc-950',
    outline: 'border border-zinc-300 hover:bg-zinc-50 text-zinc-700 dark:border-zinc-750 dark:hover:bg-zinc-900 dark:text-zinc-300 focus:ring-indigo-500 dark:focus:ring-offset-zinc-950',
    ...
    ghost: 'hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-700 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white focus:ring-zinc-500 dark:focus:ring-offset-zinc-950',
  };
