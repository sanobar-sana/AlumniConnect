      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
                    ...
                    <Link
                      ...
                      className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                        isActive(link.path)
                          ...
                          : 'text-gray-700 dark:text-gray-300 hover:bg-zinc-100 dark:hover:bg-zinc-900 hover:text-gray-900 dark:hover:text-white'
                      }`}
                    >
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg border border-zinc-200/60 dark:border-zinc-800/60 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors text-gray-700 dark:text-gray-300"
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-2 shadow-xl ring-1 ring-black/5 focus:outline-none z-40">
                      ...
                      <Link
                        ...
                        className="flex w-full items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors mt-1"
                      >
            ...
            {user && (
              <button
                ...
                className="md:hidden p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors text-gray-700 dark:text-gray-300"
              >
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-2.5 px-4 py-3 rounded-lg text-base font-semibold transition-colors ${
                    isActive(link.path)
                      ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400'
                      : 'text-gray-700 dark:text-gray-300 hover:bg-zinc-100 dark:hover:bg-zinc-900'
                  }`}
                >
